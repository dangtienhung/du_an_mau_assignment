        ...
        <main>
                    ...
                    <div class="row no-gutters slider-two-active">
                        <div class="col-lg-4">
                            <div class="slider-two-item">
                                <div class="thumb"><img src="public/layout/img/slider/s_slider_img01.jpg" alt=""></div>
                        ...
                        <div class="col-lg-4">
                            <div class="slider-two-item">
                                <div class="thumb"><img src="public/layout/img/slider/s_slider_img02.jpg" alt=""></div>
                        ...
                        <div class="col-lg-4">
                            <div class="slider-two-item">
                                <div class="thumb"><img src="public/layout/img/slider/s_slider_img03.jpg" alt=""></div>
                        ...
                        <div class="col-lg-4">
                            <div class="slider-two-item">
                                <div class="thumb"><img src="public/layout/img/slider/s_slider_img04.jpg" alt=""></div>
                        ...
                        <div class="col-lg-4">
                            <div class="slider-two-item">
                                <div class="thumb"><img src="public/layout/img/slider/s_slider_img05.jpg" alt=""></div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-7 col-lg-9">
                                <div class="cat-section-title text-center">
                                    <div class="icon"><img src="public/layout/img/icon/logo_icon.png" alt=""></div>
                                    <span class="sub-title">CHOOSE A TYPE</span>
                                    <h2 class="title">Online shopping defined by fashion <br> popular aesthetic
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="products.php">
                                    <div class="icon">
                                        <img src="public/layout/img/icon/cat_icon02.png" alt="">
                                    </div>
                                    <p><?= $each->name_product_categories; ?></p>
                                </a>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="products.php">
                                    <div class="icon">
                                        <img src="public/layout/img/icon/cat_icon03.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="products.php">
                                    <div class="icon">
                                        <img src="public/layout/img/icon/cat_icon04.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="products.php">
                                    <div class="icon">
                                        <img src="public/layout/img/icon/cat_icon05.png" alt="">
                                    </div>
                                ...
                                <ul class="nav nav-tabs" id="trendingTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="accessories-tab" data-toggle="tab"
                                            ...
                                            aria-selected="true"><?= $each->name_product_categories; ?>
                                        </a>
                                    </li>
                                    <?php } ?>
                            ...
                            <div class="tab-content tp-tab-content" id="trendingTabContent">
                                <div class="tab-pane show active" id="accessories" role="tabpanel"
                                    ...
                                    <div class="trending-products-banner banner-animation">
                                        <a href="products.php">
                                            <img src="public/layout/img/images/trending_banner.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="row trending-product-active">
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    ...
                                                    <a href="shop-details.html">
                                                        <img src="admin/public/front-end/images/products/<?php echo $products[$i]->image; ?>"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            ...
                                                            <li><a href="products.php"><i class="far fa-eye"></i></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="features-product-content">
                                                    ...
                                                    <h5><a
                                                            href="details.php"><?php echo $products[$i]->name_product; ?></a>
                                                    </h5>
                                                    <p class="price">$<?php echo $products[$i]->price; ?>.00</p>
                                                    <div class="features-product-bottom">
                                                        <ul>
                                                            <li class="color-option">
                                                                <span class="gray"></span>
                                        ...
                                        <!-- <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="public/layout/img/product/trending_product09.jpg"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="public/layout/img/product/trending_product10.jpg"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="public/layout/img/product/trending_product11.jpg"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="public/layout/img/product/trending_product12.jpg"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                ...
                                <div class="tab-pane" id="bags" role="tabpanel" aria-labelledby="bags-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="products.php"><img src="public/layout/img/images/trending_banner02.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="public/layout/img/product/trending_product08.jpg"
                                                            alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                ...
                                <div class="tab-pane" id="bSellers" role="tabpanel" aria-labelledby="bSellers-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="products.php"><img src="public/layout/img/images/trending_banner.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
            ...
            <section class="new-arrival-area pt-95 pb-45">
                <div class="container">
                    ...
                    <div class="row new-arrival-active">
                        ...
                        <?php if (isset($list_product_sale)) { ?>
                        <?php foreach ($list_product_sale as $key => $products_sale) { ?>
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="details.php"><img
                                            src="admin/public/front-end/images/products/<?php echo $products_sale->image; ?>"
                                            alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="products.php"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="content">
                                    <h5><a href="shop-details.html"><?= $products_sale->name_product; ?></a></h5>
                                    <span class="price">$<?= $products_sale->price; ?>.00</span>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                        <?php } else { ?>
                        <h2 class="text-center">Đang cập nhật</h2>
                        <?php } ?>
            ...
            <!-- discount-area -->
            <section class="discount-area discount-bg-two" data-background="public/layout/img/bg/discount_bg02.jpg">
                <div class="container">
                    <div class="row align-items-center justify-content-center justify-content-lg-start">
                        <div class="col-lg-6 col-md-8">
                            <div class="discount-content text-left">
                                <div class="icon mb-15"><img src="public/layout/img/icon/discount_icon.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-10">
                            <div class="discount-end-time-wrap">
                                <div class="icon">
                                    <img src="public/layout/img/icon/discount_icon.png" alt="">
                                </div>
                                <div class="content">
                                    <span>STOCK IS LIMITED</span>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog-post-item mb-50">
                                <div class="blog-post-thumb mb-20">
                                    <a href="blog-details.html"><img src="public/layout/img/blog/blog_thumb01.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-post-content">
                                    <div class="tag"><a href="#">Shopping</a></div>
                                    <h3><a href="blog-details.html">Erby-style shoes currently afoot presents an</a>
                                    </h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog-post-item mb-50">
                                <div class="blog-post-thumb mb-20">
                                    <a href="blog-details.html"><img src="public/layout/img/blog/blog_thumb02.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-post-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog-post-item mb-50">
                                <div class="blog-post-thumb mb-20">
                                    <a href="blog-details.html"><img src="public/layout/img/blog/blog_thumb03.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-post-content">
                                    <div class="tag"><a href="#">Creative Design</a></div>
                                    <h3><a href="blog-details.html">Clothes that never get worn, but it doesn't have</a>
                                    </h3>
                                    <div class="blog-post-meta">
                                        <ul>
                                            <li><i class="far fa-user"></i><a href="#">Jon Deo</a></li>
