                    ...
                    <div class="product-desc-wrap">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-0 text-decoration-underline">
                                            <a class="d-inline text-decoration-underline alert-light me-3"
                                                href="edit-comment.php?edit-comment=true&comment=<?= $comment->id_comment; ?>&id=<?= $comment->id_product; ?>&desc=<?= $comment->comment_desc; ?>"
                                ...
                                <form action="process-comments.php" method="POST" class="comment-form review-form">
            ...
            <div class="related-product-wrap">
                ...
                <div class="row related-product-active">
                    ...
                    <!-- <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="public/layout/img/product/n_arrival_product02.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                <a href="shop-details.html"><img src="public/layout/img/product/n_arrival_product03.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="public/layout/img/product/n_arrival_product04.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
