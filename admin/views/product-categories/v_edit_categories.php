            ...
            <div class="modal-dialog pb-3">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="edit-process-categories.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <input type="hidden" class="form-control fs-3" id="id" placeholder="Tên loại sản phẩm"
                                    name="id" value="<?= $product_category->id; ?>">
                                ...
                                <input type="text" class="form-control fs-3" id="username"
                                    ...
                                    value="<?= $product_category->name_product_categories; ?>">
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea name="descrtiption" placeholder="Mô tả sản phẩm" class="form-control fs-3"
                                    id="descrtiption" rows="3"><?= $product_category->description; ?></textarea>
                            </div>
